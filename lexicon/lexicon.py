LEXICON: dict[str, str] = {
    ...
    'not_successful_name_cat': 'Похоже, такая категория уже существует, попробуйте создать новую или удалить имеющуюся ❗',
    ...
    'back': '⬅ Назад',
    'add_to_basket': 'Добавить товар в корзину 🧾',
    ...
    'fail_ref_link': 'Регистрация по реферальной ссылке не пройдена ❗',
